...
public class StockTable {
  ...
  public static StockTable defaultTable() {
    var items = List.of(
        ...
        new StockItem("S", 30, List.of(new SpecialOffer(5, "S", 45, null, List.of("STXYZ"))), null),
        ...
        new StockItem("X", 90, List.of(new SpecialOffer(5, "X", 45, null, List.of("STXYZ"))), null),
        new StockItem("Y", 10, List.of(new SpecialOffer(5, "Y", 45, null, List.of("STXYZ"))), null),
        new StockItem("Z", 50, List.of(new SpecialOffer(5, "Z", 45, null, List.of("STXYZ"))), null)
