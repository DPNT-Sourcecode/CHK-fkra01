...
public class StockTable {
  ...
  public static StockTable defaultTable() {
    var items = List.of(
        ...
        new StockItem("H", 10, List.of(new SpecialOffer(5, "H", 45, null), new SpecialOffer(10, "H", 80, null)), null),
        new StockItem("I", 35, null, null),
        new StockItem("J", 60, null, null),
        new StockItem("K", 80, List.of(new SpecialOffer(2, "K", 150, null)), null),
        new StockItem("L", 90, null, null),
        new StockItem("M", 15, null, null),
        new StockItem("N", 40, List.of(new SpecialOffer(3, "M", 0, null)), List.of("M")),
        new StockItem("O", 10, null, null),
        new StockItem("P", 50, List.of(new SpecialOffer(5, "P", 200, null)), null),
        new StockItem("Q", 30, List.of(new SpecialOffer(3, "Q", 80, null)), null),
        new StockItem("R", 50, List.of(new SpecialOffer(3, "Q", 0, null)), List.of("Q")),
        new StockItem("S", 30, null, null),
        new StockItem("T", 20, null, null),
        new StockItem("U", 40, List.of(new SpecialOffer(3, "U", 0, 1)), null),
        new StockItem("V", 50, List.of(new SpecialOffer(2, "V", 90, null), new SpecialOffer(3, "V", 130, null)), null),
        new StockItem("W", 20, null, null),
        new StockItem("X", 90, null, null),
        new StockItem("Y", 10, null, null),
