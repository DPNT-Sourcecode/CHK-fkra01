...
public class CheckoutTest {
  ...
  @ParameterizedTest
  @CsvSource({"A,50", "B,30", "C,20", "D,15", "AA,100", "BB,45", "CC,40", "AB,80", "ABC,100", "AAA,130",  "AAAB,160", "AAABB,175", "AAABBC,195", "AAAAA,200", "AAAAAA,250", "EEB,80", "EE,80", "EEEEBB,160", "BEBEEE,160", "ABCDEABCDE,280", "EEEB,120", "ABCDECBAABCABBAAAEEAA,665"})
